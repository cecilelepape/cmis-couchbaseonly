...
public class CouchbaseService {
	...
	public CouchbaseService(String bucketId) {
		System.out.println("CouchbaseService is created with bucketId:"+bucketId);
	...
	public String getId(CmisObject parentData, String objectname)
		...
		String fullpath = ("/".equals(path) ? "/" : path + PATH_SEPARATOR) + objectname;
