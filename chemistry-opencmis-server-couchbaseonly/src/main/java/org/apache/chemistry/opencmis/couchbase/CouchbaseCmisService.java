 ...
 */
public class CouchbaseCmisService extends AbstractCmisService implements
	...
	public CouchbaseCmisService(
			final CouchbaseRepositoryManager repositoryManager) {
	...
	public ObjectInFolderList getChildren(String repositoryId, String folderId,
		...
		System.out.println("CouchbaseCmisService getChildren folderId:"
				+ folderId);
